...
var fullscreen_btn_FullscreenBtn = /*#__PURE__*/function () {
  function FullscreenBtn(controlsEl) {
    var _this = this;
    ...
    this.el.addEventListener('click', function () {
      _this.changeIcon(!_this.isFullscreen);

      _this.fullscreen(_this.isFullscreen, controlsEl);
    });
  }
  ...
  src_createClass(PrettyVideo, [{
    ...
    value: function initControls() {
      ...
      if (!this.config.hideFullScreen) {
        // 全屏按钮
        this.fullscreenBtn = new fullscreen_btn_FullscreenBtn(this.containerElemelt);
